...
class MathTest {
  ...
  // TODO
  @Test
  public void testSmaller(){assertEquals(Integer.MAX_VALUE,Math.max(Integer.MIN_VALUE,Integer.MAX_VALUE));}
  // covers a > b, a = maxint, b = minint
  // TODO
  @Test
  public void testBigger(){assertEquals(Integer.MAX_VALUE,Math.max(Integer.MAX_VALUE,Integer.MIN_VALUE));}
